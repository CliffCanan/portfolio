$(document).ready(function () {
    ...
    $("#text-scroll").typed({
        strings: [" perpetual learner", " mobile payments aficionado", " fintech entrepreneur", " self-taught coder", " hardened Philadelphia sports fan", " front-end developer", " resilient, scrappy startup vet", " web/mobile app developer", "lways asking \"why?\"", " shockingly good ping-pong player"],
        typeSpeed: 16,
